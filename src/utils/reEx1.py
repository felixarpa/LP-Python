...
for l in lines:   # itera sobre les linies de l'arxiu
    ...
    if m:
        print(m.string,end=" ")      # mostra els noms que li hem passat (en minuscules) que satisfan la condició
...
for l in lines:   # itera sobre les linies de l'arxiu
    if re.search('ez[ ,]',l.lower()): #cerca si algun cognom en minuscules acaba en ez
        print(l,end=" ")      # mostra els noms que satisfan la condició
...
for l in lines:   # itera sobre les linies de l'arxiu
    ...
    print(s,end=" ")      # mostra el resultat de la sustitucio
